...
import com.atlassian.bitbucket.jenkins.internal.jenkins.auth.JenkinsAuthorizerTrusted;
...
public class OAuthModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(TrustedUnderlyingSystemAuthorizerFilter.class).to(JenkinsAuthorizerTrusted.class).in(Singleton.class);
    }
}
